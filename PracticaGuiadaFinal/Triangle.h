...
public:
	...
	Triangle(Vector3D vertex1Coords, Vector3D vertex2Coords, Vector3D vertex3Coords, Vector3D vertex1Normal, Vector3D vertex2Normal, Vector3D vertex3Normal, Color vertex1Color, Color vertex2Color, Color vertex3Color ) :
		vertex1Coords(vertex1Coords), vertex2Coords(vertex2Coords), vertex3Coords(vertex3Coords),
		vertex1Normal(vertex1Normal), vertex2Normal(vertex2Normal), vertex3Normal(vertex3Normal),
